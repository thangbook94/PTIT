            ...
            <div class="register-part-1">
                <div class="register-part-1-contain">
                    ...
                    <form class="form-register" action="userServlet" method="post">  
                        ...
                        <h5>YOUR NAME</h5>
                        <div class="form-register-input">
                            <input placeholder="NAME" name="name" required type="text"></input>       
                        </div>
                        <div class="form-register-input">
                            <input placeholder="LAST NAME" name="last_name" required type="text"></input>       
                        </div>
                        <h5>ADDRESS</h5>
                        <div class="form-register-input">
                            <input placeholder="ADDRESS" name="address" required type="text"></input>       
                        </div>
                        <h5>EMAIL</h5>
                        <div class="form-register-input">
                            <input placeholder="EMAIL" name="email" required type="text"></input>       
                        </div>
                        <button class="register-now" type="submit" name="submit" value="register" aria-label="Register">
                            <div>
                                <span>REGISTER</span>
                            </div>
